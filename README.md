...
- [flexidot-bio/flexidot](https://github.com/flexidot-bio/flexidot) ([v2.0.2](https://github.com/flexidot-bio/flexidot/releases/tag/v2.0.2), 5 days ago) - Highly customizable, ambiguity-aware dotplots for visual sequence analyses
- [Adamtaranto/deRIP2](https://github.com/Adamtaranto/deRIP2) ([v0.4.1](https://github.com/Adamtaranto/deRIP2/releases/tag/v0.4.1), 6 days ago) - Reconstruct ancestral state sequences of fungal repeat families by correcting for RIP-like mutations. Mask RIP or deamination events from alignments.
