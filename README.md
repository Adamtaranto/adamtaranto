...
- [melbournebioinformatics/intro-to-git](https://github.com/melbournebioinformatics/intro-to-git) - Intro to Git and GitHub for researchers (today)
...
- [qjiangzhao/TEtrimmer](https://github.com/qjiangzhao/TEtrimmer) ([v1.5.1](https://github.com/qjiangzhao/TEtrimmer/releases/tag/v1.5.1), today) - TEtrimmer: a novel tool to automate manual curation of transposable elements 
