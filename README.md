...
- [Adamtaranto/tSplit](https://github.com/Adamtaranto/tSplit) ([v0.2.0](https://github.com/Adamtaranto/tSplit/releases/tag/v0.2.0), 4 days ago) - Extract terminal repeats from retrotransposons (LTRs) or DNA transposons (TIRs). Compose synthetic MITES from complete DNA transposons.
