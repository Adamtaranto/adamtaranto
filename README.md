...
- [qjiangzhao/TEtrimmer](https://github.com/qjiangzhao/TEtrimmer) ([v1.6.0](https://github.com/qjiangzhao/TEtrimmer/releases/tag/v1.6.0), today) - TEtrimmer: a novel tool to automate manual curation of transposable elements 
- [Adamtaranto/teloclip](https://github.com/Adamtaranto/teloclip) ([v0.3.2](https://github.com/Adamtaranto/teloclip/releases/tag/v0.3.2), 2 days ago) -  A tool for the recovery of unassembled telomeres from soft-clipped read alignments.
